    ...
    <div className="mx-auto max-w-[1080px]">
      ...
      <section className="fade-up-2 mt-5 grid gap-5 lg:grid-cols-[1.1fr_.9fr]">
        ...
        <div className="soft-shadow rounded-[1.5rem] border border-[#d5e4ef] bg-white p-5 sm:p-7 lg:p-6">
          ...
          <p className="mt-6 text-sm leading-6 text-slate-600 lg:mt-7 lg:translate-y-1.5">GZR Enterprises partners with teams that value precision, progress, and a job done right. Ghrazielle is here to make every next step feel straightforward.</p>
