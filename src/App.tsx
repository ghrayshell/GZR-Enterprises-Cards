          ...
          <div className="flex flex-col justify-center lg:translate-x-3">
            <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-stretch sm:gap-7">
              ...
              <div className="w-full min-w-0 text-center sm:w-auto sm:text-left">
                ...
                <p data-testid="text-employee-title" className="mt-3 text-[clamp(.72rem,3.8vw,1.125rem)] font-medium leading-6 text-[#b9dbf4] sm:mt-5 sm:text-lg"><span className="whitespace-nowrap">{employee.title}</span> <span className="mx-2 text-[#5286b4]">/</span> <span data-testid="text-employee-department" className="whitespace-nowrap">{employee.department}</span> <span className="mx-2 text-[#5286b4]">/</span> <span data-testid="text-employee-company" className="whitespace-nowrap">{employee.company}</span></p>
              </div>
            </div>
